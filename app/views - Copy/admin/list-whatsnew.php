                ...
                <div class="card-content">
                    <div class="container">
                        <form>
                            <div class="row">
                                <div class="col-md-6">
                                <h5 class="h5 text-left">What's New</h5>
                                </div>
                                <?php
                                if (($_SESSION['roleid'] == 1) || ($_SESSION['roleid'] == 2) || ($_SESSION['roleid'] == 3)) {
                                ?>
                                <div class="col-md-6 text-right">
                               <a href="AdminController/whatsnew"> <button type="button" class="btn btn-info text-white">Add New</button></a> 
                                </div>
                                <?php } ?>
                            </div>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php
                                                            $uploadPath = 'whatsnew' . '/' . $whatlist['tn_wh_new_pdf'];
                                                            $file_location = $uploadPath;
                                                            ?>
                                                            <a class="pdf_href" href="<?= $uploadPath ?>" target="_blank"><?= $whatlist['tn_wh_new_pdf'] ?></a><br>
                                                        </td>
                                                        <td>
                                                            <?php
                                                            $uploadPath = 'whatsnew' . '/' . $whatlist['en_wh_new_pdf'];
                                                            $file_location = $uploadPath;
                                                            ?>
                                                            <a class="pdf_href" href="<?= $uploadPath ?>" target="_blank"><?= $whatlist['en_wh_new_pdf'] ?></a><br>
                                                        </td>
                                                        <td>
                                                            <?php if ($whatlist['status'] == 1) {
