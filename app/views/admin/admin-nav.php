    ...
    <ul class="list-unstyled components">
        ...
        <li class="dropdown">
            ...
            <ul class="collapse list-unstyled menu" id="profile">
                ...
                <?php } ?>
                <li>
                    <a href="AdminController/list_profile">Edit</a>
                </li>
                <li>
                    <a href="AdminController/list_profile?status=<?php echo "1" ?>">View</a>
                </li>
            </ul>
        </li>
        <?php
        ...
        <li class="">
            <a href="AdminController/list_menureorder"> <i class="fa fa-clone"></i><span>Menu ReOrder</span></a>
        </li>
        <li class="">
            <a href="AdminController/list_submenureorder"> <i class="fa fa-clone"></i><span>Sub Menu ReOrder</span></a>
        </li>
        <li class="">
            <a href="AdminController/list_role_honour"> <i class="fa fa-clone"></i><span>Role of Honour</span></a>
        </li>
        <li class="">
            <a href="AdminController/list_mst_contactus"> <i class="fa fa-clone"></i><span>contactUs office</span></a>
        </li>
        <li class="">
