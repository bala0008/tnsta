                    ...
                    <div class="container">
                        <form method="POST" name="menur_form" id="menur_form" autocomplete="off" enctype="multipart/form-data">
                            <div class="row jumbotron">
                                <div class="col-sm-6 form-group">
                                    ...
                                    <select name="parent_id" id="parent_id">
                                        ...
                                        <option value="1" myTag='whatsnew'>What's New</option>
                                        <option value="2" myTag='tender'>Tender</option>
                                        <option value="3" myTag='notification'>Notification</option>
                                        <option value="4" myTag='page'>Page</option>
                                        <option value="5" myTag='profile'>Who's who</option>
                                    </select>
                                </div>
                            ...
                            <section class="section-dash">
                                <div class="container" >
                                    <div class="row justify-content-center" id="submenudash">
