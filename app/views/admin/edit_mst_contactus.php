            ...
            <form method="POST" name="mst_contactus_form" id="mst_contactus_form" autocomplete="off" enctype="multipart/form-data">
              <div class="row ">
                <div class="col-sm-6 form-group mb-0 float-right">
                  <h5 class="text-left">Create Contact Us-Office
              ...
              <div class="row jumbotron">
                <div class="col-sm-8 form-group">
                  ...
                  <select name='mst_con_dropdown' id="mst_con_dropdown">
                    ...
                    // die;
                    foreach ($data['current_mst_contactus'] as $key => $value) :

                      //foreach ([1 => 'Page', 'Internal', 'External', 'Pdf'] as $key => $value) :
                      $selected = "";
                      if ($data['sql']->mst_con_dropdown  == $value['mst_con_off_id']) {
                        $selected = "selected=\"selected\"";
                      }
                    ?>
                      <option <?php echo $selected; ?> value="<?php echo $value['mst_con_off_id']; ?>" data-id="<?php echo $value['mst_con_off_id']; ?>"><?php echo $value['en_mst_con_off_name']; ?></option>
                    <?php endforeach; ?>
                  </select>
                </div>
                ...
                <div class="col-sm-6 form-group">
                  ...
                  <input type="hidden" name="old_mst_con_dropdown" id="old_mst_con_dropdown" value="<?php if (isset($data['sql']->mst_contactus_id) && ($data['sql']->mst_contactus_id) != '') {
                                                                                                      echo $data['sql']->mst_con_dropdown;
                                                                                                    } ?>">
                  <input type="file" class="form-control pdf_only" name="en_pdf" id="pdf_only" accept="application/pdf">

                  <br>
                  <p><?php if (isset($data['sql']->mst_contactus_id) && ($data['sql']->mst_contactus_id) != '') {

                        $uploadPath = 'contactus' . '/' . $data['sql']->en_pdf;
                ...
                <div class="col-sm-12 form-group mb-0 text-center">
                  ...
                  <input type="Submit" value="Submit" name="save_mst_contactus" class="btn btn-primary btn-sm">
...
<script type="text/javascript">
  $.validator.setDefaults({
    submitHandler: function() {
      ...
      var mst_con_dropdown = $('#mst_con_dropdown').val();
      // alert(mst_con_dropdown);
      var id = $('#id').val();
      // alert(id);
  ...
  $(document).ready(function() {
    $("#mst_contactus_form").validate({
      rules: {
        mst_con_dropdown: "required",
        en_title: "required",
        tn_title: "required",
      },
      messages: {
        mst_con_dropdown: "Please enter your ContactUs Type",
        en_title: "Please enter your Title",
        tn_title: "Please enter your Title",
      },
      errorElement: "em",
...
<script>
  ...
  $('#mst_con_dropdown').change(function() {
    var baseurl = "<?php echo URLROOT; ?>AdminController/mst_contactus_ajax";
    var mst_con_dropdown = $(this).val();
    var old_mst_contactus = $("#old_mst_con_dropdown").attr('value');
    jQuery.ajax({
      url: baseurl,
      data: {
        old_mst_contactus: old_mst_contactus,
