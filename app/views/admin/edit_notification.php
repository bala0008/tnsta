                        ...
                        <form method="POST" name="notification_form" id="notification_form" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="row jumbotron">
                                ...
                                <div class="col-sm-6 form-group">
                                    ...
                                    <input type="file" class="form-control pdf_only" name="en_notification_pdf" id="en_notification_pdf"  accept="application/pdf">
                                ...
                                <div class="col-sm-6 form-group tn_notification_title">
                                    ...
                                    <input type="file" class="form-control pdf_only" name="tn_notification_pdf" id="tn_notification_pdf"  accept="application/pdf">
