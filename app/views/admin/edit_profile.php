...
?>
<img src="<?= $file_location ?>" class="rounded mx-auto d-block"  style=" width: 100px;
height: 150px;"/>
<?php  }
?>
</div>
<img id="previewImg" src="tnweb/images/transparent.png" class="img-fluid" alt="Placeholder" style=" width: 100px;
height: 150px;">
</div>
...
<input type="hidden" name="old_profile_photo" id="old_profile_photo" value="<?php if (isset($data['sql']->profile_id) && ($data['sql']->profile_id) != '') {
echo $data['sql']->profile_photo;
} ?>">
</div>
<div class="col-sm-5 form-group" style="padding: 10px;">
<div class="form-check form-check-inline">
<input class="form-check-input" type="radio" name="profile_check" id="inlineRadio1" value="cmt" <?php if (isset($data['sql']->profile_check) && ($data['sql']->profile_check) != '' && ($data['sql']->profile_check) == 'cmt') {
echo "checked";
} ?>>
<label class="form-check-label" for="inlineRadio1">Chief Minister</label>
</div>
<div class="form-check form-check-inline">
<input class="form-check-input" type="radio" name="profile_check" id="inlineRadio2" value="mt" <?php if (isset($data['sql']->profile_check) && ($data['sql']->profile_check) != '' && ($data['sql']->profile_check) == 'mt') {
echo "checked";
} ?>>
<label class="form-check-label" for="inlineRadio2">Transport Minister</label>
</div>
<div class="form-check form-check-inline">
<input class="form-check-input" type="radio" name="profile_check" id="inlineRadio3" value="hts" <?php if (isset($data['sql']->profile_check) && ($data['sql']->profile_check) != '' && ($data['sql']->profile_check) == 'hts') {
echo "checked";
} ?>>
<label class="form-check-label" for="inlineRadio3">Home Secretary</label>
</div>
<div class="form-check form-check-inline">
<input class="form-check-input" type="radio" name="profile_check" id="inlineRadio4" value="tc" <?php if (isset($data['sql']->profile_check) && ($data['sql']->profile_check) != '' && ($data['sql']->profile_check) == 'tc') {
echo "checked";
} ?>>
<label class="form-check-label" for="inlineRadio4">Transport Commissioner</label>
</div>
...
<?php
foreach (['cmt' => 'Honourable Chief Minister of Tamil Nadu', 'mt' => 'Honourable Minister For Transport', 'hts' => 'Additional Chief Secretary / Home (Transport) Secretary', 'tc' => 'Transport Commissioner'] as $key => $value) :

//foreach ([1 => 'Page', 'Internal', 'External', 'Pdf'] as $key => $value) :
$selected = "";
if (isset($data['sql']->profile_check) && ($data['sql']->profile_check)  == $key) {
...
<input type="text" class="form-control" name="profile_contact" id="profile_contact" value="<?php if (isset($data['sql']->profile_id) && ($data['sql']->profile_id) != '') {
echo $data['sql']->profile_contact;
} ?>">
</div>
<div class="col-sm-4 form-group">
<label for="address-1">Mobile<span style='color:red'>*</span> </label>
<input type="text" class="form-control" name="profile_mobile" id="profile_mobile" value="<?php if (isset($data['sql']->profile_id) && ($data['sql']->profile_id) != '') {
echo $data['sql']->profile_mobile;
} ?>">
</div>
<div class="col-sm-4 form-group">
<label for="address-1">Fax<span style='color:red'>*</span> </label>
<input type="text" class="form-control" name="profile_fax" id="profile_fax" value="<?php if (isset($data['sql']->profile_id) && ($data['sql']->profile_id) != '') {
echo $data['sql']->profile_fax;
} ?>">
</div>
<div class="col-sm-4 form-group">
<label for="address-1">Email<span style='color:red'>*</span> </label>
<input type="text" class="form-control" name="profile_email" id="profile_email" value="<?php if (isset($data['sql']->profile_id) && ($data['sql']->profile_id) != '') {
echo $data['sql']->profile_email;
} ?>">
</div>
...
<?php
foreach (['cmt' => '
மாண்புமிகு தமிழக முதல்வர்', 'mt' => 'மாண்புமிகு போக்குவரத்துத் துறை அமைச்சர்', 'hts' => '
கூடுதல் தலைமைச் செயலாளர் / உள்துறை (போக்குவரத்து) செயலாளர்', 'tc' => '
போக்குவரத்து ஆணையர்'] as $key => $value) :
