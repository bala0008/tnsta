            ...
            <div class="">
                ...
                <div class="container about">
                    <div class="breadcrumb-title">
                        <h2>Transport Commissioner </h2>
                    </div>
                    <div id="about_us" class="about-us">
                        <div class="container">
                            <div class="about-row row">
                                <div class="image-col col-md-6">
                                    <img src="<?php echo $file_location ?>" class="img-fluid" alt="" style=" width: 100px;
  height: 150px;">
                                </div>
                                                    ...
                                                    <div class="table-wrapper">
                                                        <table class="table table-striped table-cm">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <th>Mobile Number</th>
                                                                    <td><?php echo $page_contentsql['profile_mobile']; ?></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Address</td>
                                                                ...
                                                                <tr>
                                                                    <th>Fax</th>
                                                                    <td><?php echo $page_contentsql['profile_fax']; ?></td>
                                                                </tr>
                                                                <tr>
                                                                    <th>Email Id</th>
                                                                    <td><?php echo $page_contentsql['profile_email']; ?></td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                    </div>
