            ...
            <div class="col-lg-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><?php echo "Contact Us - RTO Office"; ?></li>
                    </ol>
                </nav>
            </div>
        </div>
        <div class="breadcrumb-content pt-2">
            <h3 style="text-align:center; padding: 15px;">Contact Us - RTO Office</h3>
        </div>
    </div>
    <div class="container">
        <div class="row">
                    ...
                    <div class=" table-responsive table-bordered">
                        <table id="contact_table" class="display table-bordered" style="width:100%;padding: 15px 0px;">
                            ...
                            <tbody>
                                <?php
                                $i = 1;
                                foreach ($data['current_contactus_rtooffice'] as $sn => $v_contactus_home) {
