...
<section class="mt-2 mb-2 tabs-bg">
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content home-banner">
                            <div class="tab-pane active" id="home1" role="tabpanel">
                                <marquee behavior="scroll" direction="up" scrollamount="3" style="height: 265px;" onmouseover="this.stop();" onmouseout="this.start();">
                                    ...
                                    <strong class="marquee-text-col">
                                        ...
                                        foreach ($data['current_whatsnew'] as $sn => $whatsnew) {
                                            ...
                                            //echo $date;
                                            //echo $date;
                                            $uploadPath = 'whatsnew' . '/' . $whatsnew['wh_new_pdf'];
                                ...
                                <marquee behavior="scroll" direction="up" scrollamount="3" style="height: 265px;" onmouseover="this.stop();" onmouseout="this.start();">
                                    ...
                                    <strong class="marquee-text-col">
                                        ...
                                        foreach ($data['current_notification'] as $sn => $v_notification) {
                                            ...
                                            //echo $date;
                                            //echo $date;
                                            $uploadPath = 'notification' . '/' . $v_notification['notification_pdf'];
                                            $file_location = $uploadPath;
                                        ?>
                                            <p>
                                            <h6 class="p-0 m-0">
                                    ...
                                    <table id="tendertable" class="display table-bordered" style="width:100%;padding: 15px 0px;">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($data['current_tender'] as $sn => $v_tender) {
                                                ...
                                                //echo $date;
                                                //echo $date;
                                                $uploadPath = 'tender' . '/' . $v_tender['tender_pdf'];
                                                $file_location = $uploadPath;
                                            ?>
